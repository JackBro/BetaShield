...
VERSIONHELPERAPI IsWindowsServer()
{
	...
	if (BetaFunctionTable->VerSetConditionMask)
		dwlConditionMask = BetaFunctionTable->VerSetConditionMask(0, VER_PRODUCT_TYPE, VER_EQUAL);
	else
		dwlConditionMask = VerSetConditionMask(0, VER_PRODUCT_TYPE, VER_EQUAL);

	if (BetaFunctionTable->VerifyVersionInfoW)
		return !BetaFunctionTable->VerifyVersionInfoW(&osvi, VER_PRODUCT_TYPE, dwlConditionMask);
